...
const state = {
  alarm: { time: "07:30", armed: false, genres: ["math", "code"], difficulty: "normal", sound: "beep" },
  log: [],
};
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  $("#btn-preview-sound").addEventListener("click", () => Sound.preview(selectedSound()));
  $("#btn-again").addEventListener("click", () => setScreen("setup"));

  // 動作確認ボタン（開発用）
  $("#btn-check-beep").addEventListener("click", () => {
    Sound.preview(selectedSound());
